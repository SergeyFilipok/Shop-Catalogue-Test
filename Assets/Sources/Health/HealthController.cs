...
namespace Health {
    public class HealthController : IPropertyController<int> {
        ...
        public HealthController(IPlayerProperty<int> goldProperty) {
            _goldProperty = goldProperty;
            _goldProperty.Value = DEFAULT_VALUE;
        }
            ...
            switch (delta.ActionType) {
                ...
                case ChangingActionType.Remove:
                    ...
                    if (removeValue <= _goldProperty.Value) {
                        ...
                        throw new InvalidOperationException("Not enough Health for removing!");
                    }
                    break;
                ...
                case ChangingActionType.Set:
                    if (delta.Value >= 0) {
                        ...
                        throw new InvalidOperationException("Health value can be below zero!");
                    }
                    break;
            }
        }
